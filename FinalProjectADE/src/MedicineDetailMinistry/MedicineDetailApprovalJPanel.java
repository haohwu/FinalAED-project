 ...
 */
package MedicineDetailMinistry;
 ...
 */
public class MedicineDetailApprovalJPanel extends javax.swing.JPanel {
    ...
    public MedicineDetailApprovalJPanel(JPanel userProccessContainer, EcoSystem ecosystem) {
        initComponents();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (selectedRow >= 0)
        {
            MedicineDetail selectedDrugs = (MedicineDetail) tbl_DrugApproval.getValueAt(selectedRow, 1);
            ecosystem.getMedicineDetailDirectory().deleteMedicineDetail(selectedDrugs);
            JOptionPane.showMessageDialog(null, "Drugs " + selectedDrugs.getName()+ " deleted successfully!");
            populateTable();
        }
        else
        {
    ...
    private void btn_PublishActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_PublishActionPerformed
        // TODO add your handling code here:
        MedicineDetail pe = ecosystem.getMedicineDetailDirectory().createMedicineDetail(txt_Id.getText(),txt_drug.getText(),txt_Components.getText(), text_disease.getText());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        MedicineDetail selectedDrugs_Details  = (MedicineDetail) model.getValueAt(selectedRowIndex, 1);
         selectedDrugs_Details.setName(txt_drug.getText());
         selectedDrugs_Details.setComposition(txt_Components.getText());
         selectedDrugs_Details.setSymptom(text_disease.getText());
    ...
    private void btn_viewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_viewActionPerformed
        ...
        MedicineDetail selectedDrugs_Details  = (MedicineDetail) model.getValueAt(selectedRowIndex, 1);
         ...
         txt_drug.setText(String.valueOf(selectedDrugs_Details.getName()));
         txt_Components.setText(String.valueOf(selectedDrugs_Details.getComposition()));
         text_disease.setText(String.valueOf(selectedDrugs_Details.getSymptom()));
    ...
    private void populateTable() {
        ...
        dtm.setRowCount(0); 
        int count1 = 1;
        if(ecosystem.getMedicineDetailDirectory().getMedicineDetailList()!= null)
        {
            for(MedicineDetail s : ecosystem.getMedicineDetailDirectory().getMedicineDetailList())
            {
                Object[] row = new Object[dtm.getColumnCount()]; 
                row[0] = s.getId();
                row[1] = s;
                row[2] = s.getComposition();
                row[3] = s.getSymptom();
                dtm.addRow(row);
                count1++;
            }
