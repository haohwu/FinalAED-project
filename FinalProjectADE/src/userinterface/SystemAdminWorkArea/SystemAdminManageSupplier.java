...
public class SystemAdminManageSupplier extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(btnDelete);
        btnDelete.setBounds(20, 270, 130, 23);
        ...
        add(btnCreate);
        btnCreate.setBounds(20, 370, 130, 23);
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        {
            SupplierManager selectedSupplier = (SupplierManager) tblSupplier.getValueAt(selectedRowSAMR, 1);
            ecosystem.getSupplierManagerDirectory().deleteSupplierManager(selectedSupplier);
            JOptionPane.showMessageDialog(null, "Supplier " + selectedSupplier.getSupplierManagerName()+ " deleted successfully!");
            populateTable();
        }
        else
        {
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        // TODO add your handling code here:
        SupplierManager s = ecosystem.getSupplierManagerDirectory().createSupplierManager(txtSupplierName.getText(), txtAddress.getText());
        if(s == null)
        {
        ...
        {
            JOptionPane.showMessageDialog(null, "Supplier created successfully as " + s.getSupplierManagerName());
    ...
    private void btnViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewActionPerformed
        ...
        if (selectedRow >= 0)
        {
            SupplierManager selectedSupplier = (SupplierManager) tblSupplier.getValueAt(selectedRow, 1);
    ...
    private void populateTable() {
        ...
        dtm.setRowCount(0);
        int count1 = 1;
        if(ecosystem.getSupplierManagerDirectory().getSupplierManagersList()!= null)
        {
            for(SupplierManager s : ecosystem.getSupplierManagerDirectory().getSupplierManagersList())
            {
                Object[] row = new Object[dtm.getColumnCount()];
                row[0] = s.getId();
                row[1] = s;
                row[2] = s.getSupplierMangerAddress();
                dtm.addRow(row);
                count1++;
            }
        }
