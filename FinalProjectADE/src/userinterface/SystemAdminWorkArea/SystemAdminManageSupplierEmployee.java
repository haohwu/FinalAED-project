...
import Role.DeliveryRole;
import Role.SupplierDeliveryRole;
import Role.SupplierManagerRole;
...
public class SystemAdminManageSupplierEmployee extends javax.swing.JPanel {
    ...
    public SystemAdminManageSupplierEmployee(JPanel userProcessContainer, SupplierManager supplierManager, EcoSystem ecosystem) {
        initComponents();
       ...
       if(validateThis())
        {
            ...
            Employee e = supplierManager.getEmployeeDirectory().createEmployee(txtName.getText(), txtAddress.getText(), txtPhoneNumber.getText());
            if(e == null)
            {
            ...
            else
            {
                ...
                {
                    User ua = ecosystem.getUserDirectory().creatUser(txtUsername.getText(), txtPassword.getText(), new SupplierManagerRole(), e);
                    if(ua != null)
                    {
                    ...
                    {
                        supplierManager.getEmployeeDirectory().deleteEmployee(e);
                ...
                {
                    User ua = ecosystem.getUserDirectory().creatUser(txtUsername.getText(), txtPassword.getText(), new SupplierDeliveryRole(),e);
                    if(ua != null)
                    {
                        SupplierDelivery sdm = supplierManager.getSupplierDeliveryDirectroy().createSupplierDelivery(txtName.getText(), txtAddress.getText(), txtPhoneNumber.getText());
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        {
            Employee selectedEmployee = (Employee) tblManageSupplierEmp.getValueAt(selectedRow, 1);
            supplierManager.getEmployeeDirectory().deleteEmployee(selectedEmployee);
...
private void populateSupplierEmpTable() {
        ...
        dtm.setRowCount(0);
        if(supplierManager.getEmployeeDirectory().getEmployeeList() != null)
        {
            for(Employee e : supplierManager.getEmployeeDirectory().getEmployeeList())
            {
                Object[] row = new Object[dtm.getColumnCount()];
                row[0]= e.getId();
                row[1]= e;
                User ua = ecosystem.getUserDirectory().findUser(e);
