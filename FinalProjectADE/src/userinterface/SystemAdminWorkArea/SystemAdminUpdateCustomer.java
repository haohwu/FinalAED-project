...
public class SystemAdminUpdateCustomer extends javax.swing.JPanel {
    ...
    public SystemAdminUpdateCustomer(JPanel userProcessContainer, Patient patient, EcoSystem ecosystem) {
        initComponents();
    ...
    private void btnSubmitSAUCActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitSAUCActionPerformed
        ...
        if(validateThisSAUC())
        {
            ...
            patient.setPhoneNum(txtPhoneNumber.getText());
            JOptionPane.showMessageDialog(null, "Details for " + patient.getName()+ " updated successfully!");
        }
        else
        {
            return;
