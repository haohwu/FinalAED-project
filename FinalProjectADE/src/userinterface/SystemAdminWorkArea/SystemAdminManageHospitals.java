...
import Patient.EmailValidation;
...
public class SystemAdminManageHospitals extends javax.swing.JPanel {
    ...
    private void SystemAMHSubmitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SystemAMHSubmitButtonActionPerformed
        ...
        if(validateThisSAMC())
        {
            ...
            User ua = ecosystem.getUserDirectory().creatUser(HospitalUserName, HospitalPassword, new HospitalRole(), e);
            if(ua != null)
            {
    ...
    private void populateTableHM() {
        ...
        if(ecosystem.getHospitalDirectory().getHopitalList()!= null)
        {
            for(Hospital h: ecosystem.getHospitalDirectory().getHopitalList())
            {
