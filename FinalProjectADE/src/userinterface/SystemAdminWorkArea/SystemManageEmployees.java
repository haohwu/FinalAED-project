    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
         ...
         if(validateThis())
        {
            ...
            else
            {
                ...
                {
                    User ua = ecosystem.getUserDirectory().creatUser(txtUsername.getText(), txtPassword.getText(), new SysAdmin(), e);
                    if(ua != null)
                    {
                ...
                {
                    User ua = ecosystem.getUserDirectory().creatUser(txtUsername.getText(), txtPassword.getText(), new DeliveryRole(), e);
                    if(ua != null)
                    {
                        Delivery delivery = pharmacy.getDeliveryDirectory().createDelivery(txtName.getText(), txtAddress.getText(), txtPhoneNumber.getText());
