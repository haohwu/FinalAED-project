...
import SupplierEmployee.SupplierEmployee;
import User.User;
...
public class SystemAdminManageCustomers extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        lblBackground.setBackground(new java.awt.Color(204, 0, 204));
        lblBackground.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/11-1-1024x600 (1).v1.jpg"))); // NOI18N
        add(lblBackground);
        lblBackground.setBounds(0, -260, 1200, 1030);
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        if(validateThisSAMC())
        {
            ...
            User ua = ecosystem.getUserDirectory().creatUser(txtUsername.getText(), txtPassword.getText(), new PatientRole(), e);
            if(ua != null)
            {
                Patient patient = ecosystem.getPatientDirectory().createPatient(txtName.getText(), txtAddress.getText(), txtPhoneNumber.getText());
                JOptionPane.showMessageDialog(null, "Customer account created successfully for " + patient.getName());
                populateTable();
    ...
    private void btnManageCustomerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnManageCustomerActionPerformed
        ...
        if (selectedRow >= 0)
        {
            Patient selectedCustomer = (Patient) tblCustomers.getValueAt(selectedRow, 1);
    ...
    private void btnDeleteCustomerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteCustomerActionPerformed
       int selectedRow = tblCustomers.getSelectedRow();
        ...
        {
            Patient selectedCustomer = (Patient) tblCustomers.getValueAt(selectedRow, 1);
            ecosystem.getPatientDirectory().deletePatient(selectedCustomer);
