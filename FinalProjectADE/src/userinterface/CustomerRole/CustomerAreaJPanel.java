...
public class CustomerAreaJPanel extends javax.swing.JPanel {
 private JPanel userProcessContainer;
    ...
    public CustomerAreaJPanel(JPanel userProcessContainer, User user, EcoSystem system) {
        initComponents();
        ...
        for(Patient patient : system.getPatientDirectory().getPatientList())
        {
                ...
                if(patient.getName() == null ? user.getEmployee().getName() == null : patient.getName().equals(user.getEmployee().getName()))
                {
        ...
        txtName.setText(this.patient.getName());
        txtAddress.setText(this.patient.getAddress());
        txtPhone.setText(this.patient.getPhoneNum());
        
        lblValue.setText(this.patient.getName());
        comboPharmacy.addItem("");
        for(Pharmacy p : system.getPharmacyDirectory().getPharmacyList())
        {
            comboPharmacy.addItem(p.getPharmacyName());
        }
    }
    ...
    private void comboPharmacyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_comboPharmacyActionPerformed
     // TODO add your handling code here:
        if(comboPharmacy.getSelectedItem() != "")
        {
            ...
            pharmacy = system.getPharmacyDirectory().findPharmacyName(phar);
            CustomerOrderAction cpo = new CustomerOrderAction(userProcessContainer, patient, pharmacy);
  ...
  // TODO add your handling code here:
        CustomerSummaryJPanell lcj = new CustomerSummaryJPanell(userProcessContainer, user, system);
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        else
        {
            ...
            patient.setPhoneNum(txtPhone.getText());
