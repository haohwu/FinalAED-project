...
public class AdminUpdateMedicineItem extends javax.swing.JPanel {
    ...
    Pharmacy pharmacy;
    Medicine medicine;
    public AdminUpdateMedicineItem(JPanel userProcessContainer, Medicine medicine) {
        initComponents();
        this.userProcessContainer = userProcessContainer;
        this.medicine = medicine;
        txtName.setText(medicine.getMedicineName());
        spinnerPrice.setValue(medicine.getPrice());
    }
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        {
            medicine.setPrice((Integer)spinnerPrice.getValue());
            JOptionPane.showMessageDialog(null, "Medicine " + medicine.getMedicineName()+ " updated successfully!");
        }
        else
        {
