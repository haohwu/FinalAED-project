...
public class AdminWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public AdminWorkAreaJPanel(JPanel userProcessContainer, User user, EcoSystem system) {
        initComponents();
        ...
        for(Pharmacy r : system.getPharmacyDirectory().getPharmacyList())
        {
            for(Employee e : r.getEmployeeDirectory().getEmployeeList())
            {
                ...
                {
                    this.pharmacy = r;
                    lblValue.setText(r.getPharmacyName());
                }
            } 
        }
        txtPharmcyName.setText(this.pharmacy.getPharmacyName());
        txtAddress.setText(this.pharmacy.getPharmacyAddress());
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        else if(txtPharmcyName.getText() == null ? pharmacy.getPharmacyName()!= null : !txtPharmcyName.getText().equals(pharmacy.getPharmacyName()))
        {
            if(system.getPharmacyDirectory().checkIfPharmacyNameUnique(txtPharmcyName.getText()))
            {
                pharmacy.setPharmacyName(txtPharmcyName.getText());
