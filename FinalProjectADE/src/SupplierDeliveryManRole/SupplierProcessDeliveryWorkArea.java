...
public class SupplierProcessDeliveryWorkArea extends javax.swing.JPanel {
     ...
     */
    public SupplierProcessDeliveryWorkArea(JPanel userProcessContainer, SupplierOrder supplierOrder) {
        initComponents();
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
       switch(comboResultStatus.getSelectedIndex())
        {
            case 0 : supplierOrder.setOrderStatus(true);
            break;
            case 1 : supplierOrder.setOrderStatus(false);
            break;
        }
        System.out.println(comboResultStatus.getSelectedIndex());
        System.out.println(supplierOrder.isOrderStatus());
        System.out.println(supplierOrder.getAmount());
