...
JPanel userProcessContainer;
    ...
    public SupplierAdminWorkAreaJPanel(JPanel userProcessContainer, User user, EcoSystem system) {
        initComponents();
        this.userProcessContainer = userProcessContainer;
        this.user = user;
        this.system = system;
        for(SupplierManager r : system.getSupplierManagerDirectory().getSupplierManagersList())
        {
            for(Employee e : r.getEmployeeDirectory().getEmployeeList())
            {
                if(user.getEmployee() == e)
                {
                    this.supplierManager = r;
                    lblValue.setText(r.getSupplierManagerName());
                }
            } 
        }
        txtSupplierName.setText(this.supplierManager.getSupplierManagerName());
        txtAddress.setText(this.supplierManager.getSupplierMangerAddress());
    ...
    private void btnViewOrderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewOrderActionPerformed
        // TODO add your handling code here:
         AdminManageSupplierOrders amo = new AdminManageSupplierOrders(userProcessContainer, supplierManager);
    ...
    private void btnMedicineManageActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMedicineManageActionPerformed
        // TODO add your handling code here:
         AdminManageSupplierMedicine amm = new AdminManageSupplierMedicine(userProcessContainer, supplierManager);
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        else if(txtSupplierName.getText() == null ? supplierManager.getSupplierManagerName()!= null : !txtSupplierName.getText().equals(supplierManager.getSupplierManagerName()))
        {
            if(system.getSupplierManagerDirectory().checkIfSupplierManagerUniques(txtSupplierName.getText()))
            {
                supplierManager.setSupplierManagerName(txtSupplierName.getText());
                supplierManager.setSupplierMangerAddress(txtAddress.getText());
