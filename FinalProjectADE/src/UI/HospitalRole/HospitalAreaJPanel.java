...
public class HospitalAreaJPanel extends javax.swing.JPanel {
    ...
    public HospitalAreaJPanel(JPanel userProcessContainer, User user, EcoSystem system) {
        initComponents();
        ...
        for(Hospital h : system.getHospitalDirectory().getHopitalList())
        {
            
                if(h.getHospitalName() == null ? user.getEmployee().getName()== null : h.getHospitalName().equals(user.getEmployee().getName()))
                {
                    this.hospital = h;
                }
        ...
        HospitalContactText.setText(this.hospital.getHospitalPhoneNum());
