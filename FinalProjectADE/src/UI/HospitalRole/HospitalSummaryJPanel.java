...
public class HospitalSummaryJPanel extends javax.swing.JPanel {
    ...
    public HospitalSummaryJPanel(JPanel userProcessContainer, User user, EcoSystem system) {
        initComponents();
        this.userProcessContainer = userProcessContainer;     
        this.user = user;
        this.system = system;
        for(Hospital c : system.getHospitalDirectory().getHopitalList())
        {
...
public void populateRequestTable() {
        if(hospital.getPastOrderList() != null)
        {
            ...
            int count = 1;
            for(Order o : hospital.getPastOrderList())
            {
                if(system.getPharmacyDirectory().getPharmacyList() != null)
                {
                    ...
                    {
                        for(Order or : p.getOrderDirectory().getOrderList())
                        {
                          if(o.equals(or))
                          {
                              row[1] = p;
